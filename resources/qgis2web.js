...
var map = new ol.Map({
    target: 'map',
    renderer: 'canvas',
    layers: [...layersList, wmsLayer], // Use spread operator to combine layers
    view: new ol.View({
        center: ol.proj.fromLonLat([-95, 38]), // Optional: center somewhere in CONUS
        zoom: 4,
        maxZoom: 28,
        minZoom: 1
    })
...
view: new ol.View({
    center: ol.proj.fromLonLat([-95, 38]), // USA center
    zoom: 4,
    maxZoom: 28,
    minZoom: 1
})
...
map.getView().fit([-8238402.797966, 4973459.966662, -8233897.961594, 4978521.179447], map.getSize());
